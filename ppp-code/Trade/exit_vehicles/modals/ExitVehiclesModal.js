                        ...
                        <Container>
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <input className="form-control" value={ values.monto||""} name="monto" id="monto" onChange={handleInputChange} type="number"/>
                                </Col>
                            </Row>                           
                            <Row className="mt-3">
                                <Col>
...
const mapDispatchToProps = dispatch => {
    return {
        saveExitVehicles:(form)=>dispatch(Actions.saveExitVehicles(form)),
        updateExitVehicles:(form)=>dispatch(Actions.updateExitVehicles(form))
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withDragDropContext(DriverModal));