      ...
      <tr>
          ...
          <td colspan="2" style="width:30%">
              <table>
                  ...
                  <tr><td style="font-size:14px;text-align:center;background-color: #eee;"><strong>Codigo de reserva/Habitación</strong></td></tr>
                  <tr><td style="font-size:14px;text-align:center">{{$data['resumen'][0]->codigo_reserva}}/{{$data['resumen'][0]->numero_habitacion}}</td></tr>
              </table>
          </td>    
      </tr>
  </table>
