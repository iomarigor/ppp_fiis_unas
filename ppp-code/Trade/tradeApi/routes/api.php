...
Route::get('/', function(){
    return '<p1>WELCOME BACKENT TO TRADE API</p1>';
});
...
Route::get('/salidavehiculos/{id}','SalidaVehiculosController@get_salida_vehiculos_print');
Route::get('/adelantoturno/{id}','AdelantoTurnoController@get_adelanto_turno_print');
Route::get('/encomienda/{id}','EncomiendaController@get_encomienda_print');
...
Route::middleware(['jwt.verify'])->group(function () {
   ...
   //MANTENIMIENTO DE SUBCLASE
    ...
    Route::get('/sidpersonaprovedor/{id}','PersonaController@get_persona_proveedor_id');
    ...
    Route::post('/rtransportista','TransportistaController@set_transportista_insert');
    Route::post('/atransportista','TransportistaController@set_transportista_update');
    Route::get('/etransportista/{id}','TransportistaController@set_transportista_delete');
    
    //SALIDA VEHICULOS
    Route::resource('/salidavehiculos','SalidaVehiculosController');
    Route::post('/rsalidavehiculos','SalidaVehiculosController@set_salida_vehiculos_insert');
    Route::post('/asalidavehiculos','SalidaVehiculosController@set_salida_vehiculos_update');
    Route::get('/esalidavehiculos/{id}','SalidaVehiculosController@set_salida_vehiculos_delete');

    //ADELANTO TURNO
    Route::resource('/adelantoturno','AdelantoTurnoController');
    Route::post('/radelantoturno','AdelantoTurnoController@set_adelanto_turno_insert');
    Route::post('/aadelantoturno','AdelantoTurnoController@set_adelanto_turno_update');
    Route::get('/eadelantoturno/{id}','AdelantoTurnoController@set_adelanto_turno_delete');

    //ENCOMIENDA
    Route::resource('/encomienda','EncomiendaController');
    Route::post('/rencomienda','EncomiendaController@set_encomienda_insert');
    Route::post('/aencomienda','EncomiendaController@set_encomienda_update');
    Route::get('/eencomienda/{id}','EncomiendaController@set_encomienda_anular');
    Route::get('/gencomienda/{id}','EncomiendaController@get_encomienda_detalle_lista');
    Route::post('/aencomiendaestado','EncomiendaController@set_encomienda_estado_update');
    Route::post('/rfacturacionencomienda','EncomiendaController@set_facturacion_insert');
});