...
const initialState = {
  ...
  daily_report: [],
  crud_stay: null,
  loader_send_mail: false,
  loader_guest_register: false,
  loader_comfir_register: false,
};
...
const gridReducer = function (state = initialState, action) {
  switch (action.type) {
    ...
    case Actions.LOADER_SEND_MAIL: {
      return {
        ...state,
        loader_send_mail: action.payload,
      };
    }

    case Actions.LOADER_GUEST_REGISTER: {
      return {
        ...state,
        loader_guest_register: action.payload,
      };
    }
    case Actions.LOADER_COMFIR_REGISTER: {
      return {
        ...state,
        loader_comfir_register: action.payload,
      };
    }
    default: {
      return state;
